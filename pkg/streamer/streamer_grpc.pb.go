...
func (c *streamServiceClient) FetchResponse(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_FetchResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/streamer.StreamService/FetchResponse", opts...)
	if err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "streamer.StreamService",
	...
	Metadata: "server-stream/streamer.proto",
}
